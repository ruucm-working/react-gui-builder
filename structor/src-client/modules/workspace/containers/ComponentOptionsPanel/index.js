...
class Container extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    const {
      componentModel: nextComponentModel,
      readmeText: nextReadmeText,
    } = nextProps
    ...
    if (selectedComponents && selectedComponents.length > 0) {
      ...
      if (favoriteStyleInputs.length > 0) {
        ...
        favoriteStyleSection = (
          <div key="favoriteStyleGroup" className="panel panel-info">
            <div
              className="panel-heading"
              role="tab"
            ...
            <div
              id="favoriteStyleGroup"
              className={'panel-collapse collapse ' + collapsed}
              role="tabpanel"
            >
              <div className="list-group">{favoriteStyleInputs}</div>
              <div style={{ height: '0' }} />
            </div>
          </div>
        )
